    ...
    <div className="container-fluid bg-primary p-5 bg-hero mb-5">
        <div className="row py-5">
            <div className="col-12 text-center">
                <h1 className="display-2 text-uppercase text-white mb-md-4">Blog Detail</h1>
                <a href="" className="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                <a href="" className="btn btn-light py-md-3 px-md-5">Detail</a>
            </div>
        </div>
    </div>
    ...
    <div className="container-fluid p-5">
        <div className="row g-5">
            <div className="col-lg-8">
                ...
                <div className="mb-5">
                    <img className="img-fluid w-100 rounded mb-5" src="asset/img/blog-1.jpg" alt="" />
                ...
                <div className="mb-5">
                    ...
                    <div className="d-flex mb-4">
                        <img src="asset/img/user.jpg" className="img-fluid rounded" style={{width: "45px", height: "45px"}} />
                        <div className="ps-3">
                ...
                <div className="mb-5">
                    ...
                    <div className="bg-dark rounded p-4">
                        <div className="d-flex overflow-hidden mb-3">
                            <img className="img-fluid flex-shrink-0 rounded-start" src="asset/img/blog-1.jpg" style={{width: "75px"}} alt="" />
                        ...
                        <div className="d-flex overflow-hidden mb-3">
                            <img className="img-fluid flex-shrink-0 rounded-start" src="asset/img/blog-2.jpg" style={{width: "75px"}} alt="" />
                            <a href="" className="d-flex align-items-center bg-light rounded-end h5 text-uppercase p-3 mb-0">Sed amet tempor amet sit kasd sea lorem
                            </a>
                        </div>
                        <div className="d-flex overflow-hidden mb-3">
                            <img className="img-fluid flex-shrink-0 rounded-start" src="asset/img/blog-3.jpg" style={{width: "75px"}} alt="" />
                            <a href="" className="d-flex align-items-center bg-light rounded-end h5 text-uppercase p-3 mb-0">Sed amet tempor amet sit kasd sea lorem
                            </a>
                        </div>
                        <div className="d-flex overflow-hidden mb-3">
